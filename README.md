...
```bash
npx create-next-app --example https://github.com/ryone9re/nextjs-example-with-devcontainer nextjs-app
# or
yarn create next-app --example https://github.com/ryone9re/nextjs-example-with-devcontainer nextjs-app
```
